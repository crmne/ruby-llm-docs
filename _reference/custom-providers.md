...
* [How RubyLLM Works]({% link _introduction/overview.md %}) - see where providers and protocols sit among the framework's components.
* [Provider Setup and Custom Endpoints]({% link _introduction/configuration-providers.md %}) - configure built-in providers and OpenAI-compatible endpoints.
