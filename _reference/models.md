...
If your gem directory is read-only, configure a writable location with `config.model_registry_file` (v1.9.0+). See the [Connection, Logging and Contexts Guide]({% link _introduction/configuration-connection.md %}#model-registry-file) for details.
